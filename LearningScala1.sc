object LearningScala1 {
  ...
  println(piSinglePrecision * 2)                  //> 6.2831855
  val doublePi = piSinglePrecision * 2            //> doublePi  : Float = 6.2831855
  print(doublePi)                                 //> 6.2831855
  println(f"This is chooryfury trying to code in Scala. She has aced and mastered the art of Scala coding. Hooray! And the asnwer is: $doublePi%.3f")
                                                  //> This is chooryfury trying to code in Scala. She has aced and mastered the a
                                                  //| rt of Scala coding. Hooray! And the asnwer is: 6.283
